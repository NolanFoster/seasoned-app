...
# Final Staging Database Population Script
# This script populates the staging database with recipes using the crawler
...
CRAWLER_DIR="crawler"
OUTPUT_FILE="staging_population_$(date +%Y%m%d_%H%M%S).json"
HISTORY_FILE="staging_population_history_$(date +%Y%m%d_%H%M%S).json"
