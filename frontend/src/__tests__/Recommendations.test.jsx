...
describe('Recommendations Component', () => {
  ...
  describe('Carousel Integration', () => {
    ...
    it('displays "Generated By AI" indicator for AI-generated recipes', async () => {
      ...
      const aiIndicators = screen.getAllByText('Generated By AI');
      ...
      const allIndicators = screen.getAllByText('Generated By AI');
