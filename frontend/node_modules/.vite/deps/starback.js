...
// node_modules/starback/dist/starback.mjs
var D = Object.defineProperty;
var x = Object.getOwnPropertySymbols;
var F = Object.prototype.hasOwnProperty;
var q = Object.prototype.propertyIsEnumerable;
var S = (s, t, i) => t in s ? D(s, t, { enumerable: true, configurable: true, writable: true, value: i }) : s[t] = i;
var c = (s, t) => {
...
var C = d(() => {
  ...
  p = class {
    constructor(t, i) {
      this.stars = [];
      this.config = { quantity: 100, direction: 100, speed: [0.5, 0.8], backgroundColor: "#ccc", starColor: "white", starSize: [0, 3] };
    ...
    update() {
      let t = m(this.config.direction), i = y(this.config.direction);
    ...
    generate(t, i = null) {
      if (i) {
        let { x: r, y: h } = i, o = { x: r, y: h, size: this.randomSize(), opacity: this.randomOpacity(), speed: this.randomSpeed() };
        return this.stars.push(o);
      }
      for (let r = 0; r < t; r++) {
        let h = a(0, this.canvas.width), o = a(0, this.canvas.height);
        this.stars.push({ x: h, y: o, size: this.randomSize(), opacity: this.randomOpacity(), speed: this.randomSpeed() });
      }
    }
    randomSize() {
...
var z = d(() => {
  ...
  v = class {
    constructor(t, i) {
      this.stars = [];
      this.config = { type: "line", slope: { x: 1, y: 1 }, frequency: 10, speed: 2, starSize: 100, starColor: ["#fb00ff", "#00dde0"], spread: 1, directionY: -1, directionX: 1, distanceX: 0.1, quantity: 200 };
      this.direction = 225;
      this.canvas = null;
      this.ctx = null;
      this.config = c(c({}, this.config), i), this.canvas = t, this.ctx = t.getContext("2d");
    ...
    generate() {
      for (let t = 0; t < this.config.quantity; t++) {
        let i = a(-20, this.canvas.width), r = i <= 0 ? a(0, this.canvas.height) : 0, h = 100, o = i + (this.canvas.width * this.config.distanceX + this.config.spread * i * this.config.directionX), n = o - i, e = this.canvas.height;
        this.stars.push({ x: i, y: r, length: e, height: h, progress: 0, speed: this.config.speed + Math.random() / 5, lineDash: a(50, 100), filter: { opacity: l([a(20, 100) + "%", false]) }, start: { x: i, y: r }, curve: { x: i + n * this.config.slope.x, y: r + this.canvas.height * this.config.slope.y }, startPoint: a(10, 100), end: { x: o, y: this.canvas.height } });
      }
      return this.stars;
    }
  }, b = v;
...
var T = d(() => {
  C();
  z();
  k = { width: 800, height: 600, randomOpacity: true, showFps: false, type: "dot" }, u = class {
    constructor(t, i = {}) {
      this.config = {};
      this.stars = null;
      this.canvas = null;
...
var starback_default = P();
export {
  starback_default as default
};
